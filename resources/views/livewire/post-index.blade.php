        ...
        <div class="m-2 p-2">
                      ...
                      <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @foreach ($posts as $item)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <img class="w-8 h-8 rounded-full" src="{{ Storage::url($item->image)}}" />
                            </td>
                            <td class="px-6 py-4 text-right text-sm">
                              @if (Auth::user()->user_level=='1')
                              <x-jet-button wire:click="showEditPostModel({{$item->id}})">Edit</x-jet-button>
                            @endif
                                
                                <x-jet-button class="bg-red-400 hover:bg-red-500" wire:click="deletePost({{$item->id}})">Delete</x-jet-button>
                            </td>
                            </tr>
         ...
         <div>
            <x-jet-dialog-modal wire:model="showingPostModal">
                    ...
                    <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                        <form enctype="multipart/form-data">
                          ...
                          <div class="sm:col-span-6 pt-5">
                            <label for="body1" class="block text-sm font-medium text-gray-700">Body</label>
                            <div class="mt-1">
                ...
                <x-slot name="footer">
                    @if ($isEditMode)
                    <x-jet-button wire:click="editPost">Update</x-jet-button>
