        ...
        @if (($param2)=="r1")
                ...
                @foreach ($ApprovedByDirector as $item)
                    <div class="grid grid-cols-2 gap-4 max-w-7xl mx-auto px-3 py-5"> 
                        ...
                        <div class="text-center">{{$item->name}}<br>අධ්‍යක්ෂ</div>
                    </div>
                @endforeach
        ...
        @if (($param2)=="r2")
            ...
            <div class=" py-6 text-justify text-gray-600 dark:text-gray-300 uppercase tracking-wider">
                ...
                @foreach ($ApprovedByDirectorAdmin as $item)
                    <div class="grid grid-cols-2 gap-4 max-w-7xl mx-auto px-3 py-5"> 
                        <div>දිනය : {{$item->created_at}} </div>
                        <div class="text-center">{{$item->name}}<br>අධ්‍යක්ෂ පාලන<br>කෘෂිකර්ම අධ්‍යක්ෂ ජනරාල් වෙනුවට</div>
                    </div>
                @endforeach
        ...
        @if (($param2)=="r3")
            ...
            <div class=" py-6 text-justify text-gray-600 dark:text-gray-300 uppercase tracking-wider">
                ...
                @foreach ($ApprovedByADG as $item)
                    <div class="grid grid-cols-2 gap-4 max-w-7xl mx-auto px-3 py-5"> 
                        <div>දිනය : {{$item->created_at}} </div>
                        <div class="text-center">{{$item->name}}<br>අතිරේක අධ්‍යක්ෂ ජනරාල් පාලන<br>කෘෂිකර්ම අධ්‍යක්ෂ ජනරාල් වෙනුවට</div>
                    </div>
                @endforeach
